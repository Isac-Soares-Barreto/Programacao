...
void ExpenseDialog::CreateInterface()
{
    ...
    m_dueDatePicker = new wxDatePickerCtrl(this, ID_DueDate, wxDateTime::Today(),
    ...
    // Data de pagamento com checkbox
    ...
    m_paymentDatePicker = new wxDatePickerCtrl(this, ID_PaymentDate, wxDateTime::Today(),
                                               wxDefaultPosition, wxDefaultSize,
                                               wxDP_DROPDOWN | wxDP_SHOWCENTURY);
